...
structure Simprex = struct
   ...
   ************************************************************)
  type var = string
  datatype pgm = Simprex of var list * exp (* param names, body *)
...
(* (* Uncomment this section to test your changes to 
      sexpToExp, expToSexp, and freeVarsExp *)
	
  (* Evaluation tests *)
  val tests =       
      List.app testFreeVars
